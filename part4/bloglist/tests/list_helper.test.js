...
describe("total likes", () => {
  ...
  test("when list has only many blogs, equals the sum of likes of all the blogs", () => {
...
describe("favorite blog", () => {
  test("when list has zero blog, equals an empty object", () => {
  ...
  test("when list has many blog, equals the favorite blog", () => {
    const result = listHelper.favoriteBlog(listWithSixBlog);
    expect(result).toEqual(listWithSixBlog[2]);
  });
});
